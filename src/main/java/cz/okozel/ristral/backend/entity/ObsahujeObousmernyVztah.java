 ...
 */
public interface ObsahujeObousmernyVztah<T extends AbstractEntity> {
     ...
     */
    default boolean overPritomnostSpojeniPripadneVytvor(T objekt) {
     ...
     */
    default boolean overNepritomnostSpojeniPripadneVytvor(T objekt) {
        if (!overSpojeni(objekt)) return true;
